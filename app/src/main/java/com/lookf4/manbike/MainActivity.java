...
import com.lookf4.manbike.util.SystemUiHider;
...
public class MainActivity extends Activity {
    ...
    private RequestService.Mbinder binder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.locate_button).setOnTouchListener(mDelayHideTouchListener);
    }
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            BitmapDescriptor mCurrentMarker = BitmapDescriptorFactory
                    .fromResource(R.drawable.ic_locatedot);
...
//            mBaiduMap.setMyLocationEnabled(false);
            ...
            MainActivity.this.coord.add(location.getLongitude());
            MainActivity.this.coord.add(location.getLatitude());
    ...
    public ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mService = ((RequestService.Mbinder)service).getService();
        }
    ...
    protected void onResume() {
        ...
        Intent it = new Intent(MainActivity.this, RequestService.class);
